    ...
    <div className="min-h-screen w-full">
      <div className="h-full w-full px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 tracking-tight">Çekiliş Yönetimi</h1>
          <button
            onClick={() => {
              setFormData({
                ad: '',
        ...
        {error && (
          <div className="mb-6 bg-red-100 dark:bg-red-900/20 border-l-4 border-red-500 p-4 rounded-r">
            <div className="flex">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white dark:bg-gray-900 rounded-xl shadow-lg min-h-[calc(100vh-200px)] flex items-center justify-center border border-gray-200 dark:border-gray-800">
            <div>
              ...
              <h3 className="text-xl font-medium text-gray-900 dark:text-gray-200">Henüz çekiliş bulunmuyor</h3>
              <p className="mt-2 text-gray-500 dark:text-gray-400">Yeni bir çekiliş ekleyerek başlayın.</p>
            </div>
          </div>
        ) : (
          <div className="grid grid-cols-1 gap-6">
            {cekilisler.map(cekilis => (
              <div
                key={cekilis.id}
                className={`bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden transition-all duration-300 border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 ${
                ...
                <div className="p-6">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{cekilis.ad}</h3>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button
                        ...
                        className="w-full sm:w-auto px-4 py-2 text-sm font-medium text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 transition-colors bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700"
                        title="Excel İndir"
                      >
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto px-4 py-2 text-sm font-medium text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 transition-colors bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700"
                      >
                        {selectedCekilisId === cekilis.id ? 'Kapat' : 'Kazananları Gör'}
                      </button>
                      <button
                        onClick={() => handleEdit(cekilis)}
                        className="w-full sm:w-auto px-4 py-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700"
                        title="Düzenle"
                      >
                        Düzenle
                      </button>
                      <button
                        ...
                        className="w-full sm:w-auto px-4 py-2 text-sm font-medium text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-colors bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700"
                        title="Sil"
                      >
                        Sil
                      </button>
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 w-full max-w-md shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Çekiliş Adı</label>
                  <input
                    type="text"
                    name="ad"
                    value={formData.ad}
                    onChange={handleInputChange}
                    className="w-full px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors"
                    required
                  />
                </div>
                <div>
